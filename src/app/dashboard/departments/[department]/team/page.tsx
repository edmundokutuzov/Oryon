...
export default function DepartmentTeamPage() {
  ...
  if (!department) {
    return (
        <div className="p-6 fade-in">
            <h1 className="text-3xl font-bold text-white mb-8">Departamento não encontrado</h1>
             <Card className="gradient-surface border-0 rounded-2xl p-6">
                <p className="text-white/70">O departamento que procura não existe.</p>
            </Card>
        </div>
    )
  }
  ...
  return (
    <div className="p-6 fade-in">
        <h1 className="text-3xl font-bold text-white mb-8">Equipa de {department.name}</h1>
