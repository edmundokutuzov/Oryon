    ...
    <main className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="gradient-surface p-8 md:p-10 rounded-3xl w-full max-w-md mx-4 border-2 border-primary/50 bounce-in">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-1">Oryon</h1>
          <p className="text-white/70">STANDARD BANK - Plataforma Corporativa Segura</p>
        ...
        <form action={handleLogin} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <Label
              htmlFor="remember"
              className="flex items-center gap-2 font-normal text-white/70 cursor-pointer"
            >
              <Checkbox id="remember" className="rounded bg-white/10 border-white/20 text-primary focus:ring-primary" />
              Lembrar-me
            </Label>
        ...
        <div className="mt-8 text-center">
          <p className="text-white/50 text-sm">Protegido pelo Sistema de Segurança Oryon</p>
          <div className="flex justify-center space-x-4 mt-2 text-xs text-white/40">
